 ...
 * Use the [FirstPageOnboardingFragment.newInstance] factory method to
...
class FirstPageOnboardingFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FirstPageOnboardingFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FirstPageOnboardingFragment().apply {
